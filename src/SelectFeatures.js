		...
		return (
			<React.Fragment>
				<div className={'newPUDialogPane'}>   
					...
					/>
					<ToolbarButton onClick={this.props.openTargetPopup} show={(this.props.userRole!=="ReadOnly")&&(this.props.showTargetButton)}  icon={ <FontAwesomeIcon icon={ faCrosshairs }/>} style={{marginLeft:this.props.leftmargin,width:'30px', marginTop:'5px'}} title={'Set a target for all features'}/>
