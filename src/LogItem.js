	...
	render() {
    	return (
    	    <div className={this.props.className}>
    	    	<Sync className='spin' style={{display: (this.props.message.status === "WebSocketOpen") ? 'inline' : 'none', height: '16px', width: '16px', verticalAlign: 'sub', color: 'rgb(255, 64, 129)', marginRight:'6px'}} title={'Preprocessing..'}/>
